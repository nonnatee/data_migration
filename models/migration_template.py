...
"""
    ...
    def action_get_visual_mapping_data(self):
        ...
        transform_data = [{
            ...
            'filter_field': t.filter_field or '',
            'filter_operator': t.filter_operator or '=',
            'filter_value': t.filter_value or '',
            'filter_action': t.filter_action or 'keep_if',
            'usage_hint': t.usage_hint or '',
    ...
    def action_save_visual_mapping_data(self, transformations, mappings):
        ...
        for idx, t in enumerate(transformations):
            self.env['migration.transformation.line'].create({
                ...
                'apply_filter': bool(t.get('apply_filter', False)),
                'filter_field': t.get('filter_field') or t.get('source_field'),
                'filter_operator': t.get('filter_operator', '='),
                'filter_value': t.get('filter_value', ''),
                'filter_action': t.get('filter_action', 'keep_if'),
